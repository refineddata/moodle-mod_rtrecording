...
$string['rtrecording'] = 'Connect Recording';

$string['modulenameplural'] = 'Connect Recordings';
$string['modulename'] = 'Connect Recording';
$string['pluginname'] = 'Connect Recording';
$string['pluginadministration'] = 'Connect Recording administration';
$string['intro'] = 'Introduction';
$string['launch'] = 'Launch Adobe Connect';

$string['rtrecordingcron'] = 'Connect Recording Cron';
...
$string['start'] = 'Scheduled Date';
$string['start_help'] = 'Schedule a time for the recording playback. Users will not be able to access the recording outside of this scheduled start time. Position grading not available for scheduled playback.';
...
$string['configicondisplay'] = 'Set if icons can be used on the course page to represent this activity.';
...
$string['rtrecordingicon'] = 'Custom Recording Icon';
$string['rtrecordingicondesc'] = 'This icon will replace the Refined Training standard icon and can be overridden on the activity level.';
...
$string['typelistvideo'] = 'Video';

$string['tg'] = 'Threshold';
$string['tg_help'] = 'Percent of Video Watched -> Activity Grade';

$string['tgvp'] = 'Threshold';
$string['tgvp_help'] = 'Vantage Point Percentage -> Activity Grade';
...
$string['comphdr'] = 'Recordint Completion';
...
$string['rtrecprdomgcron'] = 'Refined Recording Cron';

$string['rtrecording_name'] = 'Activity Name';
...
$string['rtrecording:addinstance'] = 'Add connect activity';

$string['past_sessions_heading'] = 'View Past Sessions';
$string['past_sessions_title']   = 'Past Sessions';

$string['hideplayer'] = 'Hide Adobe player side bar and play bar';

$string['positiongrading'] = 'Position Grading';
$string['durationgrading'] = 'Duration Grading';
$string['viewlimit']                 = 'Number of viewings: ';
$string['launch_edit']           = 'Edit this Resource at Adobe Connect Central';
$string['launch_recording'] = 'Click to view the Recording';

$string['recordingnotready'] = 'The recording is not ready to start yet.  You can enter the recording in:';
$string['recordingready'] = 'You can now launch the recording';

$string['not_ready_title'] = 'Recording not yet available';

$string['backtocourse'] = 'Back to Course';

$string['update_from_adobe'] = 'Update Activity from Adobe Connect';

$string['modulename_help'] = 'The Connect Recording activity allows recorded Adobe Connect sessions to be added to the LMS course page as a distinct gradable activity when using the Refined Data Auto Record feature, or the Refined Data <a target="_blank" href="http://www.refineddata.com/vantagepoint/">Vantage Point</a> custom pod for Adobe Connect.   The Connect Recording activity provides several flexible grading options, the ability to run a scheduled re-broadcast of the event along with the standard activity functionality.

Important note: when interested in using additional grading methods based on position reached, duration watched or participation, be sure to contact <a href="mailto:support@refineddata.com?subject=Activate%20my%20Connect%20Recording%20grading">Refined Data Support</a> to activate the custom pod and the additional grading option for your site. 

<a target="_blank" href="http://support.refineddata.com/hc/en-us/articles/206251686">More information on adding a Connect Recording</a>';

$string['browsetitle'] = 'Browse Adobe Connect';

$string['url_help'] = 'Search Adobe Connect or enter the custom URL to a recorded meeting';
$string['hideplayer_help'] = 'Ability to remove all Adobe Connect side bar and playbar from view when using Vantage Point.';
$string['displayoncourse_help'] = 'Display the icon on the course page or a link to the activity page where the icon will be displayed.';
$string['iconsize_help'] = 'Select the icon size to display or option to add your own custom image.';
$string['iconpos_help'] = 'Select the alignment of the icon to display.';
$string['iconsilent_help'] = 'Each icon displays the name of the recording, the scheduled rebroadcast date, date of orginial recording and the duration.';
$string['iconmouse_help'] = 'Each icon has a pop up menu to launch the content. Suppressing the mouseover will only suppress the pop up for students in the course.';
$string['extrahtml_help'] = 'Create your own custom text to accompany the iconic image.';
$string['forceicon_filemanager_help'] = 'Upload or drag and drop your custom iconic image to this area. We recommend using an image 64 pixels X 64 pixels.';
$string['forceicon_filemanager'] = 'Upload or drag and drop your custom iconic image to this area. We recommend using an image 64 pixels X 64 pixels.';
...
$string['popup_height_hint']     = '<font size=\"1\">Height of the popup window launched for an Adobe recording.  Determines the default size of a popup window in pixels.</font>';

$string['popup_width']          = 'Popup window width.';
$string['popup_width_hint']     = '<font size=\"1\">Width of the popup window launched for an Adobe recording.  Determines the default size of a popup window in pixels.</font>';

$string['name_help'] = 'The name of the activity that will be displayed to the user.';
$string['summary_help'] = 'A summary written about the activity that can be displayed to the user.';

$string['rtrecording_reminders'] = 'Number of Reminders';
$string['rtrecording_reminders_desc'] = 'Reminder fields to display on forms for the Recording Activity when scheduling is enabled.';
$string['has_vp'] = 'Enable Vantage Point related features in the Recording Activity Creation and Editing Form';

$string['get_vp'] = 'Your Vantage Point account is not activated. For interactive grading options while using the Recording activity <a href="mailto:support@refineddata.com?subject=Vantage Point for Recordings">click here</a> and ask about Vantage Point for Recordings.';

$string['grade_position'] = 'Position Grading';
$string['grade_position_help'] = 'Each video has 10 positions which correspond with a % as follows: Position 1 = 10%, 2 = 20%, 3 = 30%, 4 = 40%, 5 = 50%, 6 = 60%, 7 = 70%, 8 = 80%, 9 = 90%, 10 = 100%. ';

$string['grade_duration'] = 'Duration Grading';
$string['grade_duration_help'] = 'Looks at the overall duration of the video and translate the percentage watched in to a grade.';

$string['grade_vantage'] = 'Vantage Point Interaction';
$string['grade_vantage_help'] = 'Pulls the percentage of challenges from Vantage Point and calculates a grade percentage when thresholds are selected. If no thresholds are selected then the Vantage Point percentage is stored as the grade.';

$string['has_vp_part'] = 'Auto-Record';
$string['has_vp_full'] = 'Vantage Point';
